...
use App\Filament\Resources\Admin\OrderResource\Widgets\OrderStats;
...
class OrderResource extends Resource
{
   ...
   // protected static bool $canCreateAnother = false;
    ...
    {
        return [
            Admin\OrderResource\RelationManagers\PaymentsRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => Admin\OrderResource\Pages\ListOrders::route('/'),
            //'create' => Admin\OrderResource\Pages\CreateOrder::route('/create'),
            'edit' => Admin\OrderResource\Pages\EditOrder::route('/{record}/edit'),
        ];
    }
