...
class SecteurResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Clusters\Admin\Services\Resources\SecteurResource\Pages\ListSecteurs::route('/'),
            'create' => \App\Filament\Clusters\Admin\Services\Resources\SecteurResource\Pages\CreateSecteur::route('/create'),
            'edit' => \App\Filament\Clusters\Admin\Services\Resources\SecteurResource\Pages\EditSecteur::route('/{record}/edit'),
        ];
    }
}
