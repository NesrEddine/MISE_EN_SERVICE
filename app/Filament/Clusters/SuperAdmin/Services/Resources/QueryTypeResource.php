...
class QueryTypeResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Clusters\SuperAdmin\Services\Resources\QueryTypeResource\Pages\ListQueryTypes::route('/'),
            'create' => \App\Filament\Clusters\SuperAdmin\Services\Resources\QueryTypeResource\Pages\CreateQueryType::route('/create'),
            'edit' => \App\Filament\Clusters\SuperAdmin\Services\Resources\QueryTypeResource\Pages\EditQueryType::route('/{record}/edit'),
        ];
    }
}
